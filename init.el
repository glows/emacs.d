...
(custom-set-variables
 ...
 '(hl-todo-keyword-faces
   '(("TODO" . "#dc752f")
	 ...
	 ("XXX+" . "#dc752f")
	 ("\\?\\?\\?+" . "#dc752f")))
 '(hydra-posframe-mode t nil (hydra-posframe))
